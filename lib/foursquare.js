...
//Fetch the stores near a location
const fetchFastFoodStores = async (
  latLong = "40.748627838930304,-73.98528717577388",
  limit = "30"
) => {
  try {
    ...
    const data = await response.json(); //fetched stores without photos
...
const fetchOneFastFoodStore = async (fsq_id = "4ddf7c1ae4cde756db33f4e3") => {
  try {
    ...
    //Getting photos of the store and add them to the store object
