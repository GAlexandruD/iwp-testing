      ...
      <div className="container px-6 py-10 mx-auto">
        <div className="lg:flex lg:items-center">
          <div className="w-full space-y-12 lg:w-1/2 ">
            ...
            <Link href="/iwant">
              <div className="md:flex md:items-start md:-mx-4 cursor-pointer">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    A wonderful space to speak by typing. This service is free
                    and made with love for the non-verbal community.
                  </p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/fastfood">
              <div className="md:flex md:items-start md:-mx-4 cursor-pointer">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    Are you hungry and want to find the best food? Search for a
                    fast food restaurant near you.
                  </p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/recipes">
              <div className="md:flex md:items-start md:-mx-4 cursor-pointer">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    Want to try something new? Search for your new favorite
                    recipe and start cooking.
                  </p>
                </div>
              </div>
            </Link>
          ...
          <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
            <div className="h-full w-full m-10">
              <Image
                ...
                src="/static/two_kids_bw_tv8pki.jpg"
                alt="two kids"
              />
            </div>
          </div>
